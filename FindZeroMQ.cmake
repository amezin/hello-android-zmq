...
if(MSVC)
  ...
  set(_zmq_static_release_names)
  set(_zmq_static_debug_names)
  foreach( ver ${_zmq_versions})
    ...
    list(APPEND _zmq_static_release_names "libzmq${_zmq_TOOLSET}-mt-s-${ver}")
    list(APPEND _zmq_static_debug_names "libzmq${_zmq_TOOLSET}-mt-sgd-${ver}")
  endforeach()
  ...
  find_library(ZeroMQ_STATIC_LIBRARY_RELEASE
    NAMES ${_zmq_static_release_names} zmq libzmq
    HINTS ${ZeroMQ_ROOT_DIR}/lib
    )

  find_library(ZeroMQ_STATIC_LIBRARY_DEBUG
    NAMES ${_zmq_static_debug_names} zmq libzmq
    HINTS ${ZeroMQ_ROOT_DIR}/lib
    )
  ...
  if(ZeroMQ_STATIC_LIBRARY_RELEASE AND ZeroMQ_STATIC_LIBRARY_DEBUG)
    set(ZeroMQ_STATIC_LIBRARY
        debug ${ZeroMQ_STATIC_LIBRARY_DEBUG}
        optimized ${ZeroMQ_STATIC_LIBRARY_RELEASE}
        )
  elseif(ZeroMQ_STATIC_LIBRARY_RELEASE)
    set(ZeroMQ_STATIC_LIBRARY ${ZeroMQ_STATIC_LIBRARY_RELEASE})
  elseif(ZeroMQ_STATIC_LIBRARY_DEBUG)
    set(ZeroMQ_STATIC_LIBRARY ${ZeroMQ_STATIC_LIBRARY_DEBUG})
  endif()
  ...
  find_library(ZeroMQ_STATIC_LIBRARY NAMES zmq-static libzmq-static
               HINTS ${ZeroMQ_ROOT_DIR}/lib
               )
endif()
...
if(ZeroMQ_FIND_STATIC)
  find_package_handle_standard_args(ZeroMQ DEFAULT_MSG
    ZeroMQ_STATIC_LIBRARY
    ZeroMQ_INCLUDE_DIR
    )
  set(ZeroMQ_LIBRARIES ${ZeroMQ_STATIC_LIBRARY})
else()
  find_package_handle_standard_args(ZeroMQ DEFAULT_MSG
    ZeroMQ_LIBRARY
    ZeroMQ_INCLUDE_DIR
